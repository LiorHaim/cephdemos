...
radosgw-admin user create --uid=data-engineering-demo --display-name=data-engineering-demo --access-key=${AWS_ACCESS_KEY_ID} --secret-key=${AWS_SECRET_ACCESS_KEY}
aws s3 mb s3://music-chart-songs-store-changelog --endpoint-url http://s3.spaz.local:8080
